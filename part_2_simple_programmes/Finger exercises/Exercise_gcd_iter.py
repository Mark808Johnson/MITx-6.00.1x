...
# until you either reach a case where the test divides both a and b without remainder,
# or you reach 1.
...
print(f"Expected maximum factor of {a} and {b} is 6")
print(f"Calculated maximum factor of {a} and {b} is {gcdIter(a, b)}")
